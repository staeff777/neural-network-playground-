        ...
        <tbody>
          {data.map((d, i) => {
            ...
            if (isClassification) {
              ...
              displayTarget =
                typeof d.target === "number" ? d.target.toFixed(2) : d.target;
            }

            return (
              <tr
                key={i}
                style={{ background: rowColor, borderBottom: "1px solid #ddd" }}
              >
                ...
                <td style={targetStyle}>{displayTarget}</td>
                {d.text && (
                  <td
                    style={{
                      padding: "8px",
