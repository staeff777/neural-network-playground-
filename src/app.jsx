      ...
      <div className="container">
        <header>
          ...
          <nav className="sim-selector" aria-label="Debug Navigation" style={{ fontSize: '0.8rem', marginTop: '5px' }}>
            <a href="?sim=linear_regression" onClick={(e) => onNavigate(e, 'linear_regression')} style={{ marginRight: '10px' }}>Back to App</a>
          </nav>
        </header>
        <main>
          <ArchitectureGallery />
      ...
      <header>
        ...
        <nav className="sim-selector" aria-label="Phase Navigation" style={{ fontSize: '0.8rem', marginTop: '5px' }}>
          <a
            ...
            onClick={(e) => onNavigate(e, 'linear_regression')}
          ...
          <a
            ...
            onClick={(e) => onNavigate(e, 'logistic_regression')}
          ...
          <a
            ...
            onClick={(e) => onNavigate(e, 'multiple_inputs')}
          ...
          <a
            ...
            onClick={(e) => onNavigate(e, 'single_layer_nonlinear')}
          ...
          <a
            ...
            onClick={(e) => onNavigate(e, 'double_layer_nonlinear')}
